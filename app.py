...
Em síntese, conclui-se que, nas condições atuais, o condomínio dispõe de capacidade para a instalação de até {fmt(qtd_op1)} carregadores veiculares de 7.4KW ou, alternativamente, {fmt(qtd_op2)} carregadores veiculares de 3.7KW, no cenário sem a adoção do sistema de gerenciamento de carga."""
